...
import { InsertUpdateUserDTO, UpdateSelfUserDTO } from './user.dto';
...
export class UserApi {
  ...
  public updateSelf(data: User, password: string): Observable<APIResponse<User>> {
    return this.httpService.put(`${this._api}/me`, new UpdateSelfUserDTO(data, password), { accessToken: true }).mapObjectResponse((item: object) => new User(item));
  }
}
