...
export class HttpService{
  ...
  public post(url: string, data: unknown = null, options: HttpOptions = null): Observable<APIResponse<unknown>> {
    const takingLong = this.setTakingLongTimeout();
  ...
  public put(url: string, data: unknown = null, options: HttpOptions = null): Observable<APIResponse<unknown>> {
    const takingLong = this.setTakingLongTimeout();
  ...
  public patch(url: string, data: unknown = null, options: HttpOptions = null): Observable<APIResponse<unknown>> {
    const takingLong = this.setTakingLongTimeout();
