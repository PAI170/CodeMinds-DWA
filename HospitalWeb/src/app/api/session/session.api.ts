...
export class SessionApi {
  ...
  public login(email: string, password: string): Observable<APIResponse<SessionTokens>> {
    return this.httpService.post(this._api, new LoginSessionDTO(email, password)).mapObjectResponse((item: object) => new SessionTokens(item));
  }
